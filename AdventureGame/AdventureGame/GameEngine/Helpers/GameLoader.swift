...
public class GameLoader {
    ...
    private var feedbackMessage: ((_: String) -> ())?
    ...
    public func load(game: Adventure, fromDataFile: String, feedback: @escaping (String)->()) {
        ...
        game.flags = BitFlags()
        game.savedRooms = [Int](repeating: 0, count: game.SAVED_ROOM_COUNT)
        ...
        // Load version info
        game.gameHeader.GameVersion = try! gameData.readInt()
        game.gameHeader.GameId = try! gameData.readInt()
        game.gameHeader.GameTrailer = try! gameData.readInt()
    }
